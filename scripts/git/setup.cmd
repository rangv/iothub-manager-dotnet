...
:USAGE
    ...
    echo   With sandbox: the build process runs inside a Docker container so you don't need to install .NET Core 2 and other dependencies
    echo   Without sandbox: the build process runs using .NET Core 2 and other dependencies from your workstation
    echo.
    echo Usage:
